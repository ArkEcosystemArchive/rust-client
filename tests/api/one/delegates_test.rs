...
#[test]
fn test_all() {
    let _mock = mock_http_server("delegates");
    {
...
#[test]
fn test_show() {
    let _mock = mock_http_server("delegates/get");
    {
        let client = mock_client_one();
...
#[test]
fn test_count() {
    let _mock = mock_http_server("delegates/count");
    {
        let client = mock_client_one();
...
#[test]
fn test_search() {
    let _mock = mock_http_server("delegates/search");
    {
        let client = mock_client_one();
...
#[test]
fn test_voters() {
    let _mock = mock_http_server("delegates/voters");
    {
        let client = mock_client_one();
...
#[test]
fn test_fee() {
    let _mock = mock_http_server("delegates/fee");
    {
        let client = mock_client_one();
...
fn test_forged_by_account() {
    let _mock = mock_http_server("delegates/forging/getForgedByAccount");
    {
        let client = mock_client_one();
...
fn test_next_forgers() {
    let _mock = mock_http_server("delegates/getNextForgers");
    {
        let client = mock_client_one();
...
fn test_forging_status() {
    let _mock = mock_http_server("delegates/forging/status");
    {
        let client = mock_client_one();
